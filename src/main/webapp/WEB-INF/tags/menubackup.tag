...
<!-- 			<img class="restaurante" src="/keepfood/img/keepfood-menu.png" /> -->
			<span>Simple Project</span>
			<i class="fa fa-bars" id="hamburguer-nav" aria-hidden="true"></i>
		</a>
		<a class="navbar-brand" href="${linkTo[IndexController].index() }" id="menu-toggle">
			<i class="fa fa-home" id="hamburguer-nav" aria-hidden="true"></i>
		</a>
	</nav>
		...
		<div class="nav-side-menu hidden-print">
			<div class="brand">
				<div class="navbar-user">
					<span class="profile-text">
						...
						<a href="${linkTo[LoginController].desloga()}">(sair)</a>
					</span>
				</div>
				<div id="normal-brand">
			...
			<div class="menu-list">
				<ul id="menu-content" class="menu-content collapse out">
					<li id="inicio-li" class="a"><a href="${linkTo[IndexController].index()}"> Inicio</a></li>
			...
			<c:if test="${usuarioLogado.usuario.tipo=='ADMIN'}">
				<div id="admin-brand">
					<h4 id="admin-brand-text">
						<i class="fa fa-circle" aria-hidden="true" id="icon-adm-mode"></i>Modo Administrador
					</h4>
				</div>
			</c:if>
		</div>